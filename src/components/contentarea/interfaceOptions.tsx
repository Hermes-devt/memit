...
export function InterfaceOptions(props: Props){
  ...
  return ( <span id="interfaceContainer">
    {/* <ExplodeQuestions forceUpdate={props.forceIt} activeNote={activeNote} /> */}

    {layout === 1 && <TextAreas1 forceUpdate={props.forceIt} activeNote={activeNote} /> } {layout === 2 && <TextAreas2 forceUpdate={props.forceIt} activeNote={activeNote} /> }
